...
OSF.DDA.EventDispId={
	...
	var initOSFModule=function OSF$initOSFModule() {
		...
		OSF.DDA.PowerPointDocument=function OSF_DDA_PowerPointDocument(officeAppContext, settings) {
			throw OSF.OUtil.formatString(Strings.OfficeOM.L_NotImplemented, 'PowerPointDocument');
		};
		...
		OSF._OfficeAppFactory=(function OSF__OfficeAppFactory() {
			...
			var _settings;
			var _hostFacade;
			var _WebAppState={ id : null, webAppUrl : null, conversationID : null, clientEndPoint : null, window : window.parent, focused : false };
			var _isRichClient=true;
			var retrieveIframeInfo=function OSF__OfficeAppFactory$retrieveIframeInfo() {
			...
			var initialize=function OSF__OfficeAppFactory$initialize() {
				...
				if (!_isRichClient) {
					...
					_WebAppState.serviceEndPoint=Microsoft.Office.Common.XdmCommunicationManager.createServiceEndPoint(_WebAppState.id);
					var notificationConversationId=_WebAppState.conversationID+OSF.SharedConstants.NotificationConversationIdSuffix;
					_WebAppState.serviceEndPoint.registerConversation(notificationConversationId);
					var notifyAgave=function OSF__OfficeAppFactory_initialize$notifyAgave(actionId) {
						switch (actionId) {
							case OSF.AgaveHostAction.Select:
								_WebAppState.focused=true;
								window.focus();
								break;
							case OSF.AgaveHostAction.UnSelect:
								_WebAppState.focused=false;
								break;
							default:
					...
					_WebAppState.serviceEndPoint.registerMethod("Office_notifyAgave",
																		notifyAgave,
																		Microsoft.Office.Common.InvokeType.async,
																		false);
					window.onfocus=function () {
						if (!_WebAppState.focused) {
							_WebAppState.focused=true;
							_WebAppState.clientEndPoint.invoke("ContextActivationManager_notifyHost", null, [_WebAppState.id, OSF.AgaveHostAction.Select]);
						}
					}
					window.onblur=function () {
						if (_WebAppState.focused) {
							_WebAppState.focused=false;
							_WebAppState.clientEndPoint.invoke("ContextActivationManager_notifyHost", null, [_WebAppState.id, OSF.AgaveHostAction.UnSelect]);
						}
					}
				}
				...
				if (!basePath) throw OSF.OUtil.formatString("Office Web Extension script library file name should be {0} or {1}.", OSF.ConstantNames.OfficeJS, OSF.ConstantNames.OfficeDebugJS);
				getAppContextAsync(_WebAppState.window, function (appContext) {
					...
					function appReady() {
						if (Microsoft.Office.WebExtension.initialize !=undefined) {
							...
							if (appContext.get_appName()==OSF.AppName.OutlookWebApp || appContext.get_appName()==OSF.AppName.Outlook) {
								_context=new OSF.DDA.OutlookContext(appContext, _settings, license, appOM);
								...
								_context=new OSF.DDA.Context(appContext, doc, license);
					...
					var postLoadLocaleStringInitialization=function OSF__OfficeAppFactory_initialize$postLoadLocaleStringInitialization() {
						...
						errorMgr.addErrorMessage(errorCodes.ooeCoercionTypeNotSupported ,  { name : stringNS.L_InvalidCoercion , message : stringNS.L_CoercionTypeNotSupported });
						errorMgr.addErrorMessage(errorCodes.ooeGetSelectionNotMatchDataType,  { name : stringNS.L_DataReadError , message : stringNS.L_GetSelectionNotSupported });
						errorMgr.addErrorMessage(errorCodes.ooeCoercionTypeNotMatchBinding,  { name : stringNS.L_InvalidCoercion , message : stringNS.L_CoercionTypeNotMatchBinding });
						errorMgr.addErrorMessage(errorCodes.ooeInvalidGetRowColumnCounts,  { name : stringNS.L_DataReadError , message : stringNS.L_InvalidGetRowColumnCounts });
						errorMgr.addErrorMessage(errorCodes.ooeSelectionNotSupportCoercionType,  { name : stringNS.L_DataReadError , message : stringNS.L_SelectionNotSupportCoercionType });
						errorMgr.addErrorMessage(errorCodes.ooeInvalidGetStartRowColumn,  { name : stringNS.L_DataReadError , message : stringNS.L_InvalidGetStartRowColumn });
						errorMgr.addErrorMessage(errorCodes.ooeNonUniformPartialGetNotSupported,  { name : stringNS.L_DataReadError , message : stringNS.L_NonUniformPartialGetNotSupported });
						errorMgr.addErrorMessage(errorCodes.ooeGetDataIsTooLarge,  { name : stringNS.L_DataReadError , message : stringNS.L_GetDataIsTooLarge });
						errorMgr.addErrorMessage(errorCodes.ooeFileTypeNotSupported,  { name : stringNS.L_DataReadError , message : stringNS.L_FileTypeNotSupported });
						errorMgr.addErrorMessage(errorCodes.ooeUnsupportedDataObject,  { name : stringNS.L_DataWriteError , message : stringNS.L_UnsupportedDataObject });
						errorMgr.addErrorMessage(errorCodes.ooeCannotWriteToSelection,  { name : stringNS.L_DataWriteError , message : stringNS.L_CannotWriteToSelection });
						errorMgr.addErrorMessage(errorCodes.ooeDataNotMatchSelection,  { name : stringNS.L_DataWriteError , message : stringNS.L_DataNotMatchSelection });
						errorMgr.addErrorMessage(errorCodes.ooeOverwriteWorksheetData,  { name : stringNS.L_DataWriteError , message : stringNS.L_OverwriteWorksheetData });
						errorMgr.addErrorMessage(errorCodes.ooeDataNotMatchBindingSize,  { name : stringNS.L_DataWriteError , message : stringNS.L_DataNotMatchBindingSize });
						errorMgr.addErrorMessage(errorCodes.ooeInvalidSetStartRowColumn,  { name : stringNS.L_DataWriteError , message : stringNS.L_InvalidSetStartRowColumn });
						errorMgr.addErrorMessage(errorCodes.ooeInvalidDataFormat,  { name : stringNS.L_InvalidFormat , message : stringNS.L_InvalidDataFormat });
						errorMgr.addErrorMessage(errorCodes.ooeDataNotMatchCoercionType,  { name : stringNS.L_InvalidDataObject , message : stringNS.L_DataNotMatchCoercionType });
						errorMgr.addErrorMessage(errorCodes.ooeDataNotMatchBindingType,  { name : stringNS.L_InvalidDataObject , message : stringNS.L_DataNotMatchBindingType });
						errorMgr.addErrorMessage(errorCodes.ooeSetDataIsTooLarge,  { name : stringNS.L_DataWriteError , message : stringNS.L_SetDataIsTooLarge });
						errorMgr.addErrorMessage(errorCodes.ooeNonUniformPartialSetNotSupported,  { name : stringNS.L_DataWriteError , message : stringNS.L_NonUniformPartialSetNotSupported });
						errorMgr.addErrorMessage(errorCodes.ooeSelectionCannotBound,  { name : stringNS.L_BindingCreationError , message : stringNS.L_SelectionCannotBound });
						errorMgr.addErrorMessage(errorCodes.ooeBindingNotExist,  { name : stringNS.L_InvalidBindingError , message : stringNS.L_BindingNotExist });
						errorMgr.addErrorMessage(errorCodes.ooeBindingToMultipleSelection,  { name : stringNS.L_BindingCreationError , message : stringNS.L_BindingToMultipleSelection });
						errorMgr.addErrorMessage(errorCodes.ooeInvalidSelectionForBindingType,  { name : stringNS.L_BindingCreationError , message : stringNS.L_InvalidSelectionForBindingType });
						errorMgr.addErrorMessage(errorCodes.ooeOperationNotSupportedOnThisBindingType,  { name : stringNS.L_InvalidBindingOperation , message : stringNS.L_OperationNotSupportedOnThisBindingType });
						errorMgr.addErrorMessage(errorCodes.ooeNamedItemNotFound,  { name : stringNS.L_BindingCreationError , message : stringNS.L_NamedItemNotFound });
						errorMgr.addErrorMessage(errorCodes.ooeMultipleNamedItemFound,  { name : stringNS.L_BindingCreationError , message : stringNS.L_MultipleNamedItemFound });
						errorMgr.addErrorMessage(errorCodes.ooeInvalidNamedItemForBindingType,  { name : stringNS.L_BindingCreationError , message : stringNS.L_InvalidNamedItemForBindingType });
						errorMgr.addErrorMessage(errorCodes.ooeUnknownBindingType,  { name : stringNS.L_InvalidBinding , message : stringNS.L_UnknownBindingType });
						errorMgr.addErrorMessage(errorCodes.ooeSettingNameNotExist,  { name : stringNS.L_ReadSettingsError , message : stringNS.L_SettingNameNotExist });
						errorMgr.addErrorMessage(errorCodes.ooeSettingsCannotSave,  { name : stringNS.L_SaveSettingsError , message : stringNS.L_SettingsCannotSave });
						errorMgr.addErrorMessage(errorCodes.ooeSettingsAreStale,  { name : stringNS.L_SettingsStaleError , message : stringNS.L_SettingsAreStale });
						errorMgr.addErrorMessage(errorCodes.ooeOperationNotSupported,  { name : stringNS.L_HostError , message : stringNS.L_OperationNotSupported });
						errorMgr.addErrorMessage(errorCodes.ooeInternalError,  { name : stringNS.L_InternalError , message : stringNS.L_InternalErrorDescription });
						errorMgr.addErrorMessage(errorCodes.ooeDocumentReadOnly,  { name : stringNS.L_PermissionDenied , message : stringNS.L_DocumentReadOnly });
						errorMgr.addErrorMessage(errorCodes.ooeEventHandlerNotExist,  { name : stringNS.L_EventRegistrationError , message : stringNS.L_EventHandlerNotExist });
						errorMgr.addErrorMessage(errorCodes.ooeInvalidApiCallInContext,  { name : stringNS.L_InvalidAPICall , message : stringNS.L_InvalidApiCallInContext });
						errorMgr.addErrorMessage(errorCodes.ooeShuttingDown,  { name : stringNS.L_ShuttingDown , message : stringNS.L_ShuttingDown });
						errorMgr.addErrorMessage(errorCodes.ooeUnsupportedEnumeration, { name : stringNS.L_UnsupportedEnumeration, message : stringNS.L_UnsupportedEnumerationMessage });
						errorMgr.addErrorMessage(errorCodes.ooeIndexOutOfRange, { name : stringNS.L_IndexOutOfRange, message : stringNS.L_IndexOutOfRange });
						errorMgr.addErrorMessage(errorCodes.ooeCustomXmlNodeNotFound,  { name : stringNS.L_InvalidNode , message : stringNS.L_CustomXmlNodeNotFound });
						errorMgr.addErrorMessage(errorCodes.ooeCustomXmlError,  { name : stringNS.L_CustomXmlError , message : stringNS.L_CustomXmlError });
						errorMgr.addErrorMessage(errorCodes.ooeNoCapability,  { name : stringNS.L_PermissionDenied , message : stringNS.L_NoCapability });
						function initializeSettings(refreshSupported) {
							...
							if(refreshSupported) {
								_settings=new OSF.DDA.RefreshableSettings(deserializedSettings);
							} else {
								_settings=new OSF.DDA.Settings(deserializedSettings);
							}
						}
						if (appContext.get_appName()==OSF.AppName.Excel) {
							var excelScriptLoaded=function() {
								initializeSettings(false );
								doc=new OSF.DDA.ExcelDocument(appContext, _settings);
								appReady();
							};
							...
							var wordScriptLoaded=function() {
								initializeSettings(false );
								doc=new OSF.DDA.WordDocument(appContext, _settings);
								appReady();
							};
							...
							var powerPointScriptLoaded=function() {
								initializeSettings(false );
								doc=new OSF.DDA.PowerPointDocument(appContext, _settings);
								appReady();
							};
							...
							var outlookScriptLoaded=function() {
								initializeSettings(false );
								appOM=new OSF.DDA.OutlookAppOm(appContext, _WebAppState.window, appReady);
							};
							...
							var projScriptLoaded=function() {
								doc=new OSF.DDA.ProjectDocument(appContext);
								appReady();
							};
						...
						window.confirm=function OSF__OfficeAppFactory_initialize$confirm (message) {
							throw OSF.OUtil.formatString(Strings.OfficeOM.L_NotSupported, 'window.confirm');
						};
						window.alert=function OSF__OfficeAppFactory_initialize$alert (message) {
							throw OSF.OUtil.formatString(Strings.OfficeOM.L_NotSupported, 'window.alert');
						};
						window.prompt=function OSF__OfficeAppFactory_initialize$prompt (message, defaultvalue) {
							throw OSF.OUtil.formatString(Strings.OfficeOM.L_NotSupported, 'window.prompt');
						};
					};
					var fallbackLocaleTried=false;
					var loadLocaleStringCallback=function OSF__OfficeAppFactory$initialize$loadLocaleStringCallback() {
						if (typeof Strings=='undefined' || typeof Strings.OfficeOM=='undefined') {
							if(!fallbackLocaleTried) {
								fallbackLocaleTried=true;
								var fallbackLocaleStringFile=OSF.OUtil.formatString("{0}{1}/{2}", basePath, OSF.ConstantNames.DefaultLocale, OSF.ConstantNames.OfficeStringJS);
								OSF.OUtil.loadScript(fallbackLocaleStringFile, loadLocaleStringCallback);
							} else {
								throw OSF.OUtil.formatString("Neither the locale, {0} , provided by the host app nor the fallback locale {1} are supported.",
									appContext.get_appUILocale().toLowerCase(),
					...
					OSF.OUtil.loadScript(localeStringFile, loadLocaleStringCallback, OSF.ConstantNames.LocaleStringLoadingTimeout);
				});
			};
			initialize();
			return {
