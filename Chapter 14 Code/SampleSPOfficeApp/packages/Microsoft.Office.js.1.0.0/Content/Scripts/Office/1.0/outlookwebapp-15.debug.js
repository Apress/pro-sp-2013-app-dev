/* Outlook web application specific OM library */
/* Version: 15.0.4440.1000 */
/*
	...
	Object.defineProperties(this, {
		...
		"saveAsync": {
			value: function OSF_DDA_Settings$saveAsync(options) {
				...
				var getInvocationCallback=function (errorCode, result) {
					if(callback) {
						var initArgs={};
						var errorArgs;
						...
						if (result.error !==0) {
							...
							errorArgs[OSF.DDA.AsyncResultEnum.ErrorProperties.Message]=result.errorMessage;
						}
						var asyncResult=new OSF.DDA.AsyncResult(initArgs, errorArgs);
						callback(asyncResult);
					}
				};
				OSF._OfficeAppFactory.getClientEndPoint().invoke("saveSettingsAsync", getInvocationCallback,  [serializedSettings]);
			}
		}
	});
};
