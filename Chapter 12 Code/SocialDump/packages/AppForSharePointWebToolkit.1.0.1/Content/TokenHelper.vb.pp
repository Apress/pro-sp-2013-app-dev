...
#Region "public methods"
    ...
    Public Shared Function GetRealmFromTargetUrl(targetApplicationUri As Uri) As String
        ...
        Catch e As WebException
            ...
            Dim realmIndex As Integer = bearerResponseHeader.IndexOf(bearer, StringComparison.Ordinal) + bearer.Length

            If bearerResponseHeader.Length > realmIndex Then
                Dim targetRealm = bearerResponseHeader.Substring(realmIndex, 36)
...
#Region "private fields"
    ...
    Private Const SharePointPrincipal As String = "00000003-0000-0ff1-ce00-000000000000"
